...
public class PermissionsManager {
  ...
  public boolean checkPermission(Guild guild, Member member,
                                 String permission) {
    if (guild.getOwnerIdLong() == member.getIdLong())
      return true;
    HashMap<UUID, PermissionsData> permissionsData =
        Disc0rd.getMysql()
            .getServerSettings(guild.getIdLong())
            .getPermissionsData();
  ...
  public HashMap<String, String> getPermissions() { return permissions; }

  public HashMap<String, Boolean> getDefaultValues() { return defaultValues; }
}
