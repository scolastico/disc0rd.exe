...
import com.scolastico.discord_exe.event.handlers.MessageReactionRemoveHandler;
...
public class OnDeReactWithEmoji implements Disc0rdEvent, MessageReactionRemoveHandler, EventHandler {
    @Override
    public void registerDisc0rdEvent() {
        Disc0rd.getEventRegister().registerMessageReactionRemoveEvent(this);
    }

    @Override
    public String getName() {
        return "On de react with emoji";
    }

    @Override
    public String getDescription() {
        return "Triggers if an member de- react with an emoji under a message\n\n" +
